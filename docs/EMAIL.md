...
|----------|------|--------------|
| [EmailJS](https://www.emailjs.com/) | Client diagnostic summary; portal alerts; admin support ping; enterprise inquiry notify | Dashboard: service + template HTML |
| [FormSubmit](https://formsubmit.co/) | Silent lead form when someone finishes diagnostic | Address in `js/ra-contact.js` → `ops` |
